            ...
            <main>
                <div class="sidebar">
                    <ul>
                        ...
                        <li className = "textz"><a class="Admin" href="#"> Data Entry </a></li>
                        <li className = "svg"><NavLink to="/AdminSettings" class="svg"> <img className="settings" src={ dataEntry } /> </NavLink></li>
